...
import 'package:event_handler/cores/widgets/phone_number_formatter/src/providers/phone_number_validator.dart';
...
class _InputWidgetState extends State<InternationalPhoneNumberInput> {
      ...
      getParsedPhoneNumber(parsedPhoneNumberString, country?.alpha2Code).then((
        ...
        if (phoneNumber == null) {
          ...
          if (widget.onInputChanged != null) {
            ...
            widget.onInputChanged!(numberItem!);
          }
          // log("::::::Checker ::: 2");
  ...
  InputDecoration getInputDecoration(InputDecoration? decoration) {
    InputDecoration value =
        ...
        InputDecoration(
          ...
          hintStyle: TextStyle(color: context.borderPrimary),
        );
    return value;
  }
  ...
  void onChanged(String value) async {
    await phoneNumberControllerListener();
  ...
  String? validator(String? value) {
    ...
    genRef!
        ...
        .updateNumberValidation(isValid, numberItem!);
    return null;
  }
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  CustomText(
                    text: widget.label2 ?? "Phone number ",
